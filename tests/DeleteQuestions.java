...
AndroidDriver<AndroidElement> driver;
	...
	public void test1() throws InterruptedException{
		...
		Dimension size = driver.manage().window().getSize();
		  ...
		  driver.findElement(By.id("com.sololearn.htmltrial:id/filter_spinner")).click();
		  driver.findElement(By.name("My Questions")).click();
		  // need to add same question
		  driver.findElement(By.name("How to add videos in html?")).click();
		  driver.findElement(By.id("com.sololearn.htmltrial:id/btn_more")).click();
		  driver.findElement(By.name("Delete")).click();
		  driver.findElement(By.name("Delete")).click();
		  Thread.sleep(2000);
		  if(driver.findElement(By.name("Q&A Discussions"))!=null){
