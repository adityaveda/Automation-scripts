...
AndroidDriver<AndroidElement> driver;
	...
	public void test1() throws InterruptedException{
		  ...
		  driver.findElement(By.id("com.sololearn.htmltrial:id/fab")).click();
		  Thread.sleep(3000);
		  driver.findElement(By.id("com.sololearn.htmltrial:id/input_title")).sendKeys("How to add videos in html?");
		  driver.findElement(By.id("com.sololearn.htmltrial:id/input_post")).sendKeys("Can anyone tell me how to add video in html?");
		 driver.navigate().back();
		  driver.findElement(By.id("com.sololearn.htmltrial:id/write_page_post_btn")).click();
